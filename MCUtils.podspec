...
Pod::Spec.new do |s|
  s.name             = 'MCUtils'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MCUtils.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Marcio Paludo/MCUtils'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Marcio Paludo' => 'marciofochesatopaludo@gmail.com' }
  s.source           = { :git => 'https://github.com/Marcio Paludo/MCUtils.git', :tag => s.version.to_s }
